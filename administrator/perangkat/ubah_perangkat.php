...
<body>
    ...
    <table id="theTable">
        <form action="admin.php?n=pubah_perangkat" method="post" enctype="multipart/form-data">
            ...
            include "../koneksi.php";
            extract($_GET);
            // Pastikan variabel koneksi ada
            $query = "SELECT * FROM perangkat WHERE id_perangkat='$id_perangkat'";
            // Tambahkan koneksi database sebagai argumen pertama
            ...
            <tr>
                <td><a href="admin.php?n=perangkat_<?php echo $back; ?>&page=1" class="button"><img src='../asset/icon/back.png' width='15px' height='15px'>Kembali</a></td>
            </tr>
        </form>
    </table>
</body>
