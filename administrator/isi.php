...
if(isset($n))
{
	...
	else if($n=="umkm")include"umkm/umkm.php";
	...
	//data umkm
	else if($n=="tambah_umkm")include"umkm/tambah_umkm.php";
	else if($n=="ubah_umkm")include"umkm/ubah_umkm.php";
	else if($n=="simpan_umkm")include"umkm/simpan_umkm.php";
	else if($n=="hapus_umkm")include"umkm/hapus_umkm.php";
	else if($n=="pubah_umkm")include"umkm/pubah_umkm.php";
	//data Profil
