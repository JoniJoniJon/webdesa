...
if(empty($_SESSION['sesi'])){
    ...
    <head>
        ...
        <!-- JavaScript untuk menampilkan waktu saat ini -->
        <script>
    ...
    <body onload="updateClock()">
        <center>
            <img src="../images/banner.png" width="980">
            <table align="center" class="admtab" border="1" width="980">
                <tr>
                    <td align="center">
		</br>
                        <!-- Menampilkan waktu saat ini -->
                        <div id="clock" style="font-size: 30px; font-weight: bold;"></div><br>
                        <?php
                ...
                <tr>
                    <td colspan="2" align="center">
                        <p align="center">Copyright &copy; 2024 Kelompok 23 KKN UNISLA</p>
                    </td>
                </tr>
            </table>
